...
strRandom = str(random.random()) #Gets random number and converts to string
hash = "0x"+hashlib.sha256(strRandom.encode('utf-8')).hexdigest() #Converts the random string to hash
